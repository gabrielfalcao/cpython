MacOS::
  ...
  export CFLAGS="-I$(brew --prefix gdbm)/include -I$(brew --prefix xz)/include -I$(brew --prefix tcl-tk)/include ${CFLAGS}"
  export CPPFLAGS="-I$(brew --prefix gdbm)/include -I$(brew --prefix xz)/include -I$(brew --prefix tcl-tk)/include ${CPPFLAGS}"
  export LDFLAGS="-L$(brew --prefix gdbm)/lib -I$(brew --prefix xz)/lib -I$(brew --prefix tcl-tk)/lib ${LDFLAGS} "
